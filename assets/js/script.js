  ...
  if (window.location.href.indexOf("schedule") > -1) {
    ...
    function createCards(events) {
      const cards = events.map((event) =>
        createEl("div", { class: "card-body clickable", onClick: () => onEventClick(event) }, createEl("h5", { class: "card-title" }, event.title || ""), createEl("p", { class: "card-text" }, event.description || createLoremIpsum()), createEl("hr"))
      );
      return cards;
    }
